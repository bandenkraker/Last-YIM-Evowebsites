    ...
    <div className="min-h-screen">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            {services.map((service, index) => (
              <div key={index} className="bg-white rounded-2xl p-10 border border-beige-300 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-start space-x-5 mb-8">
                  <div className="w-16 h-16 bg-yim-green rounded-xl flex items-center justify-center flex-shrink-0">
                    <service.icon className="w-8 h-8 text-white" />
                  </div>
                  <div>
                    <h3 className="text-3xl font-medium text-[#272727] mb-3">{service.title}</h3>
                ...
                <div className="space-y-4">
                  {service.benefits.map((benefit, idx) => (
                    <div key={idx} className="flex items-start space-x-3">
                      <CheckCircle className="w-6 h-6 text-yim-gold flex-shrink-0 mt-0.5" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {approach.map((phase, index) => (
              <div key={index} className="relative">
                <div className="bg-beige-100 rounded-2xl p-10 text-center h-full hover:shadow-xl transition-all duration-300 border border-beige-300">
                  <div className="text-6xl font-medium text-yim-green mb-6">{phase.step}</div>
                  <h3 className="text-2xl font-medium text-[#272727] mb-4">{phase.title}</h3>
      ...
      <section className="section-padding bg-beige-200">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <div className="absolute -inset-4 bg-white rounded-3xl -z-10"></div>
              <img
            ...
            <div className="space-y-10">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-5 p-6 bg-white rounded-xl border border-beige-300 shadow-sm">
                  <div className="w-14 h-14 bg-beige-200 rounded-xl flex items-center justify-center flex-shrink-0">
                    <TrendingUp className="w-7 h-7 text-yim-green" />
                  </div>
                  <div>
                    <h3 className="font-medium text-[#272727] mb-2 text-xl">Meetbare verbeteringen</h3>
                ...
                <div className="flex items-start space-x-5 p-6 bg-white rounded-xl border border-beige-300 shadow-sm">
                  <div className="w-14 h-14 bg-beige-200 rounded-xl flex items-center justify-center flex-shrink-0">
                    <Target className="w-7 h-7 text-yim-green" />
                  </div>
                  <div>
                    <h3 className="font-medium text-[#272727] mb-2 text-xl">Strategische impact</h3>
                    <p className="text-gray-600 text-lg">
                ...
                <div className="flex items-start space-x-5 p-6 bg-white rounded-xl border border-beige-300 shadow-sm">
                  <div className="w-14 h-14 bg-beige-200 rounded-xl flex items-center justify-center flex-shrink-0">
                    <CheckCircle className="w-7 h-7 text-yim-green" />
                  </div>
                  <div>
                    <h3 className="font-medium text-[#272727] mb-2 text-xl">Duurzame oplossingen</h3>
                    <p className="text-gray-600 text-lg">
